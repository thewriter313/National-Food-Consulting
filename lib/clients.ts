...
export const clients: Client[] = [
  ...
  { name: 'Butt Karahi (Mississauga)',  logo: 'Butt Karahi (Mississauga).webp',           abbr: 'BK',   color: 'from-green-800 to-green-950' },
  ...
  { name: 'Drayton Chop House',         logo: 'Drayton Chop House.webp',                  abbr: 'DCH',  color: 'from-amber-800 to-amber-950' },
  ...
  { name: 'La Ciel',                    logo: 'La Ciel.webp',                              abbr: 'LC',   color: 'from-indigo-800 to-indigo-950' },
